...
class TestImages(unittest.TestCase):
    ...
    def test_rotate_left(self):
        rotated = solution_submitted.rotate_left(self.image)
    ...
    def test_rotate_left_rectangle(self):
        rotated = solution_submitted.rotate_left(self.rectangle_image)
    ...
    def test_rotate_right(self):
        rotated = solution_submitted.rotate_right(self.image)
    ...
    def test_rotate_right_rectangle(self):
        rotated = solution_submitted.rotate_right(self.rectangle_image)
    ...
    def test_lighten(self):
        lighten = solution_submitted.lighten(self.image, 0.5)
    ...
    def test_lighten_rectangle(self):
        lighten = solution_submitted.lighten(self.rectangle_image, 0.5)
    ...
    def test_darken(self):
        darken = solution_submitted.darken(self.image, 0.5)
    ...
    def test_darken_rectangle(self):
        darken = solution_submitted.darken(self.rectangle_image, 0.5)
    ...
    def test_invert(self):
        inverted = solution_submitted.invert(self.image)
    ...
    def test_invert_rectangle(self):
        inverted = solution_submitted.invert(self.rectangle_image)
        expected = [
    ...
    def test_create_histogram(self):
        self.assertEqual(
            solution_submitted.create_histogram(self.image),
            {'blue': {0: 6, 255: 3},
             'green': {0: 5, 255: 4},
             'red': {0: 7, 255: 2}})
    ...
    def test_create_histogram_rectangle(self):
        self.assertEqual(
            solution_submitted.create_histogram(self.rectangle_image),
